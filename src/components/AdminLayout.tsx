...
const adminHeaderCardClass =
  'w-full rounded-2xl border border-white/[0.14] overflow-visible backdrop-blur-[1.25rem] shadow-[0_4px_16px_-4px_rgba(0,0,0,0.3)]';
...
export default function AdminLayout() {
  ...
  return (
    <div className="app-admin-region relative min-h-screen min-h-[100dvh] w-full text-white font-sans antialiased flex flex-col safe-area-pad overflow-x-clip overflow-y-auto page-depth-bg" style={{ background: bgTheme.appBg }}>
      ...
      <div className="app-horizontal-pad mx-auto w-full max-w-[96rem] flex min-h-0 flex-1 flex-col">
      <header className="sticky top-0 z-40 shrink-0 pt-[max(80px,env(safe-area-inset-top,0px))] md:pt-[max(24px,env(safe-area-inset-top,0px))] pb-2">
        <div className={`${adminHeaderCardClass}`}>
          <div className="flex items-center justify-between gap-2 px-3 md:px-4 py-2">
            ...
            >
              <ArrowLeft className="w-4 h-4 shrink-0 text-white/70" />
