...
export default function InstallPage() {
  ...
  // Pagina visibile SOLO se l'app NON è installata: in modalità standalone
  // (app installata) si salta direttamente al login.
  const installed = isAppInstalled();
  useEffect(() => {
    if (installed) navigate(PATH_PROFILO, { replace: true });
  }, [installed, navigate]);
